...
options.register('fileName', '', VarParsing.multiplicity.singleton, VarParsing.varType.string,
    'Name of the input file')
options.register('run', 1, VarParsing.multiplicity.singleton, VarParsing.varType.int,
    'Run number')
options.register('event', 0, VarParsing.multiplicity.singleton, VarParsing.varType.int,
    'Event number')
