 ...
 * AN-2012/251). Each hadron is counted only once; it case of ambiguity (when its decay products are
 * shared among several jets), it is assigned to the harder jet.
 */
